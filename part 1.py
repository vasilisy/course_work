...
def save_image(coords, name):
    res_image = requests.get('https://maps.googleapis.com/maps/api/streetview?size=600x300&location='+coords+'&pitch=0&fov=120&radius=10&key=AIzaSyAjSPCl4G3JOz8cXWL5GGiczLQHeVV37D8', stream=True)
